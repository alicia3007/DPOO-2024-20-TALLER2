...
public class SandboxListas
{
    ...
    {
    	List<Integer> copiaListaEnteros = new ArrayList<Integer>();
    	
    	for (int i=0;i<listaEnteros.size();i++)
    	{
			Integer siguiente = listaEnteros.get(i);
    		copiaListaEnteros.add(siguiente);
    	}
    ...
    {
    	List<String> copiaListaCadenas = new ArrayList<String>();
    	
    	for (int i=0; i<listaCadenas.size(); i++)
    	{
			String siguiente = listaCadenas.get(i);
    		copiaListaCadenas.add(siguiente);
    	}
    ...
    public void reiniciarArregloEnteros( double[] valores )
  	{
        ...
        {
            this.listaEnteros.add((int) Math.floor(valor));
        }
    ...
    public void organizarEnteros( )
    {
    	...
    	for(int i = 0; i < listaEnteros.size(); i++)
    	{
    		for(int j = i + 1; j < listaEnteros.size(); j++ )
    		{
    			...
    			{
                    t = listaEnteros.get(i);
                    listaEnteros.set(i, listaEnteros.get(j));
                    listaEnteros.set(j, t);
    			}
    		}
    	}
    ...
    public void generarEnteros(int cantidad, int minimo, int maximo) 
    {
        ...
        {
            double numero_r = Math.random() * (maximo - minimo + 1) + minimo;
            int entero = (int) numero_r;
            listaEnteros.add(entero);
        }
    }
