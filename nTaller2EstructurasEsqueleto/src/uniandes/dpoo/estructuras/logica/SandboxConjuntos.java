...
public class SandboxConjuntos
{
    ...
    public Collection<String> getSiguientes( String cadena )
    {
        ...
        for (String strSet : this.arbolCadenas) 
        {
            if (strSet.compareTo(cadena) >= 0) 
            {
                resultadoFinal.add(strSet);
            }
        }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        arbolCadenas.removeIf(elemento -> elemento.toLowerCase().equals(cadenaMinuscula));
    }
    ...
    {
    	TreeSet<String> mayusculas = new TreeSet<>(this.arbolCadenas);
    	this.arbolCadenas.clear();
    ...
    {
    	TreeSet<String> organizadas = new TreeSet<>(Comparator.reverseOrder());
    	for(String cadena : this.arbolCadenas) 
    	{
    		organizadas.add(cadena);
    	}
    	return organizadas;
    }
